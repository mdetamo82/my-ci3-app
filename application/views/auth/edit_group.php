<div class="card card-primary">
    ...
    <p class="card-subtitle ml-3 mt-2"><?php echo lang('edit_group_subheading');?></p>
    
    <div id="infoMessage" class="ml-3"><?php echo $message;?></div>

    <?php echo form_open(current_url(), ['id' => 'editGroupForm']);?>
    <div class="card-body">
        <div class="row">
            <!-- Group Name -->
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    ...
                    <?php echo form_input($group_description, '', 'class="form-control" id="description"');?>
                </div>
                <div class="invalid-feedback d-block"></div>
            </div>
        </div>
