...
<body class="hold-transition sidebar-mini">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fas fa-dollar-sign mr-2"></i>Staff Transaction Report</h1>
                        </div>
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                            ...
                            <form method="POST" action="" id="reportForm">
                                <div class="filter-row">
                                    <div class="filter-group">
                                        <label><i class="fas fa-user-tie mr-1"></i>Staff Member</label>
                                        <select name="staff_id" id="staffSelect" class="form-control" onchange="updateBankDropdown()">
                                            <option value="">All Staff</option>
                                            <?php foreach($staff_list as $staff): ?>
                                            <option value="<?php echo $staff->staff_id; ?>" <?php echo $selected_staff == $staff->staff_id ? 'selected' : ''; ?>>
                                                <?php echo $staff->name; ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                                    ...
                                    <div class="filter-group">
                                        <label><i class="fas fa-university mr-1"></i>Bank</label>
                                        <select name="bank_name" id="bankSelect" class="form-control" <?php echo empty($bank_list) ? 'disabled' : ''; ?>>
                                            <option value="">All Banks</option>
                                            <?php foreach($bank_list as $bank): ?>
                                            <option value="<?php echo $bank->bank_name; ?>" <?php echo $selected_bank == $bank->bank_name ? 'selected' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="info-box shadow summary-card">
                                <span class="info-box-icon" style="background-color: <?php echo $net_total >= 0 ? '#4cc9f0' : '#f72585'; ?>">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $t->bank_name ?? 'N/A'; ?></td>
    ...
    <script>
        ...
        // Function to update bank dropdown based on selected staff
        function updateBankDropdown() {
            const staffId = document.getElementById('staffSelect').value;
            const bankSelect = document.getElementById('bankSelect');
            
            if (staffId) {
                // AJAX request to get banks for selected staff
                fetch('<?php echo site_url("admin/staff/get_staff_banks"); ?>?staff_id=' + staffId)
                    ...
                    .then(data => {
                        ...
                        if (data.length > 0) {
                            ...
                            if ("<?php echo $selected_bank; ?>") {
                                bankSelect.value = "<?php echo $selected_bank; ?>";
                            }
                        } else {
                ...
                // If no staff selected, show all non-empty banks
                fetch('<?php echo site_url("admin/staff/get_staff_banks"); ?>')
                    .then(response => response.json())
                    .then(data => {
                        bankSelect.innerHTML = '<option value="">All Banks</option>';
        ...
        function exportTo(format) {
            ...
            form.action = '<?php echo site_url("staff_transaction/export"); ?>/' + format;
            form.submit();
        ...
        document.getElementById('exportImage').addEventListener('click', async function() {
            ...
            try {
                ...
                link.download = `Staff_Report_${timestamp}.png`;
        ...
        document.getElementById('exportPDF').addEventListener('click', async function() {
            ...
            try {
                ...
                // Download PDF
                const timestamp = new Date().toISOString().replace(/[:.]/g, '-');
                pdf.save(`Staff_Report_${timestamp}.pdf`);
