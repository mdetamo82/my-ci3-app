            ...
            <div class="row">
              ...
              <div class="form-group col-md-4">
                 ...
                 <div class="input-group">
                     ...
                     <select name="hawala_id" id="hawala_id" class="form-control" required>
                         <option value="">Select Hawala</option>
                         <?php foreach ($hawalas as $h): ?>
                             <option value="<?= $h->hawala_id ?>" <?= set_select('hawala_id', $h->hawala_id, isset($transaction) && $transaction->hawala_id == $h->id); ?>>
                                 <?= $h->name ?>
                             </option>
                         <?php endforeach; ?>
                     </select>
