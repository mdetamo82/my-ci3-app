                ...
                <div class="profile-card card">
                  <div class="card-body">
                    <div class="profile-header d-flex align-items-center">
                      ...
                      <div class="ml-3">
                        <h1 class="profile-name"><?= safe_html($loan->name); ?></h1>
                      </div>
                    </div>
                ...
                <div class="balance-card card">
                  <div class="card-body d-flex align-items-center">
                    ...
                    <div class="balance-content">
                      ...
                      <div class="balance-amount"><?= safe_html(number_format($loan->balance , 2)); ?> ETB</div>
                    </div>
                  </div>
                </div>
              </div>
                                            ...
                                            <tr style="<?= !is_null($s->updated_by) ? 'color: black; background-color: #fff3cd;' : '' ?>">
                                              ...
                                              <td>
                                                  <div class="d-flex">
                                                      ...
                                                      <a href="<?= site_url('admin/loan_transaction/edit/'.$s->id) ?>" class="btn btn-sm btn-default action-btn"  title="Edit">
                                                      <i class="fas fa-edit text-info"></i>
                                                      </a>
                                                    
                                                      <button class="btn btn-sm btn-default action-btn" title="Permanently Delete" onclick="confirmDelete('<?= site_url('admin/loan_transaction/delete') ?>', <?= $s->id ?>)">
